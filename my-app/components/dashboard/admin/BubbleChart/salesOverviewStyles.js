...
// Bubble Chart colors with transparency
export const BUBBLE_CHART_COLORS = [
  "rgba(137, 14, 238, 0.7)", // Product Sales - Purple
  "rgba(255, 107, 107, 0.7)", // Marketing Impact - Red
  "rgba(16, 185, 129, 0.7)", // Customer Engagement - Green
];

export const BUBBLE_CHART_HOVER_COLORS = [
  "rgba(137, 14, 238, 0.9)", // Product Sales hover
  "rgba(255, 107, 107, 0.9)", // Marketing Impact hover
  "rgba(16, 185, 129, 0.9)", // Customer Engagement hover
];
